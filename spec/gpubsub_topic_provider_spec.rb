...
describe Puppet::Type.type(:gpubsub_topic).provider(:google) do
  before(:all) do
          ...
          context 'title == name (pass)' do
            ...
            let(:catalog) do
              apply_with_error_check(
                <<-MANIFEST
                gpubsub_topic { 'title0':
                  ensure     => present,
                  project    => 'test project#0 data',
                  credential => 'cred0',
                }

                gpubsub_topic { 'title1':
                  ensure     => present,
                  project    => 'test project#1 data',
                  credential => 'cred1',
                }

                gpubsub_topic { 'title2':
                  ensure     => present,
            ...
            context 'Gpubsub_topic[title0]' do
              subject do
                catalog.resource('Gpubsub_topic[title0]').provider
              end

              it { is_expected.to have_attributes(name: 'title0') }
            end

            context 'Gpubsub_topic[title1]' do
              subject do
                catalog.resource('Gpubsub_topic[title1]').provider
              end

              it { is_expected.to have_attributes(name: 'title1') }
            end

            context 'Gpubsub_topic[title2]' do
              subject do
                catalog.resource('Gpubsub_topic[title2]').provider
              end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gpubsub_topic[title0]').provider.ensure
          end
        ...
        context 'title == name (pass)' do
          ...
          subject do
            apply_with_error_check(
              ...
              MANIFEST
            ).catalog.resource('Gpubsub_topic[title0]')
              .provider.ensure
          end
  ...
  context '#flush' do
    subject do
      Puppet::Type.type(:gpubsub_topic).new(
        ensure: :present,
        name: 'my-name'
      ).provider
    end

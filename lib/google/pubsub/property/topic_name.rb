...
module Google
  module Pubsub
    module Data
      ...
      # Imports name from topic
      class TopicNameRef
        include Comparable

        def ==(other)
          return false unless other.is_a? TopicNameRef
      ...
      class TopicNameRefCatalog < TopicNameRef
    ...
    module Property
      # A class to manage fetching name from a topic
      class TopicNameRef < Puppet::Property
        ...
        def self.unsafe_munge(value, resource = nil)
          return if value.nil?
          Data::TopicNameRefCatalog.new(value, resource)
        end

        # Used for fetched JSON values
        def self.api_munge(value)
          return if value.nil?
          Data::TopicNameRefApi.new(value)
        end
      end
    end
  end

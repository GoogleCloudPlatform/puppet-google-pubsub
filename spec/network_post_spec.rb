...
describe Google::Pubsub::Network::Post do
  let(:credential) { TestCred.new }
  let(:uri_in) { Google::Pubsub::NetworkBlocker::ALLOWED_TEST_URI }
  ...
  context 'successful request' do
    before(:each) do
      Google::Pubsub::NetworkBlocker.instance.allow_post(
  ...
  context 'failed request' do
    before(:each) { Google::Pubsub::NetworkBlocker.instance.deny(uri_in) }

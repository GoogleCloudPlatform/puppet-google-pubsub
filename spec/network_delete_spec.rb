...
describe Google::Pubsub::Network::Delete do
  let(:credential) { TestCred.new }
  let(:uri) { Google::Pubsub::NetworkBlocker::ALLOWED_TEST_URI }

  context 'verify proper request' do
    before(:each) { Google::Pubsub::NetworkBlocker.instance.allow_delete(uri) }
  ...
  context 'failed request' do
    before(:each) { Google::Pubsub::NetworkBlocker.instance.deny(uri) }

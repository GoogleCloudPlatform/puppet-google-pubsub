...
Puppet::Type.type(:gpubsub_topic).provide(:google) do
  mk_resource_methods
  ...
  def self.prefetch(resources)
    ...
    resources.each do |name, resource|
      ...
      Google::ObjectStore.instance.add(:gpubsub_topic, resource)
    end
  end
  ...
  def flush
    ...
    update_req = Google::Pubsub::Network::Put.new(self_link(@resource),
                                                  fetch_auth(@resource),
                                                  'application/json',
                                                  resource_to_request)

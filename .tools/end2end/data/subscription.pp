...
#       puppet apply .tools/end2end/data/subscription.pp
#
...
gpubsub_topic { 'puppet-e2e-conversation-1':
  ensure     => present,
  project    => 'google.com:graphite-playground',
  credential => 'mycred',
}

gpubsub_subscription { 'puppet-e2e-subscription-1':
  ensure               => present,
  topic                => 'puppet-e2e-conversation-1',
  push_config          => {
